...
function RangePicker(props) {
  ...
  return (/*#__PURE__*/
    React.createElement("div", { style: { userSelect: "none" } }, /*#__PURE__*/
    React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 } }, /*#__PURE__*/
    React.createElement("button", { type: "button", className: "cal-nav", onClick: function () {nav(-1);}, "aria-label": "Mes anterior" }, /*#__PURE__*/React.createElement(Icon.chevL, { size: 18 })), /*#__PURE__*/
    React.createElement("div", { style: { fontWeight: 600, fontSize: 14.5, color: "var(--ink)", fontFamily: "var(--serif)" } },
    FDL.MESES[view.m] + " " + view.y
    ), /*#__PURE__*/
    React.createElement("button", { type: "button", className: "cal-nav", onClick: function () {nav(1);}, "aria-label": "Mes siguiente" }, /*#__PURE__*/React.createElement(Icon.chevR, { size: 18 }))
    ), /*#__PURE__*/

    React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(7,1fr)", gap: 2, marginBottom: 4 } },
    FDL.DIAS.map(function (d) {
      return /*#__PURE__*/React.createElement("div", { key: d, style: { textAlign: "center", fontSize: 10.5, fontWeight: 700, color: "var(--ink-faint)", letterSpacing: ".04em", paddingBottom: 2 } }, d);
    })
    ), /*#__PURE__*/
    ...
    grid.map(function (c) {
      ...
      return (/*#__PURE__*/
        ...
        c.day,
        occ && !stt.isStart && !stt.isEnd && /*#__PURE__*/
        React.createElement("span", { style: { position: "absolute", bottom: 4, left: "50%", transform: "translateX(-50%)", width: 4, height: 4, borderRadius: 999, background: "oklch(0.6 0.13 25)" } })
    ...
    React.createElement("div", { style: { display: "flex", gap: 14, marginTop: 12, fontSize: 11, color: "var(--ink-faint)", flexWrap: "wrap" } }, /*#__PURE__*/
    React.createElement("span", { style: { display: "flex", alignItems: "center", gap: 5 } }, /*#__PURE__*/React.createElement("span", { style: { width: 11, height: 11, borderRadius: 4, background: "var(--brand-700)" } }), "Seleccionado"), /*#__PURE__*/
    React.createElement("span", { style: { display: "flex", alignItems: "center", gap: 5 } }, /*#__PURE__*/React.createElement("span", { style: { width: 11, height: 11, borderRadius: 4, background: "var(--surface-2)", border: "1px solid var(--line)" } }), "Ocupada"), /*#__PURE__*/
    React.createElement("span", { style: { display: "flex", alignItems: "center", gap: 5 } }, /*#__PURE__*/React.createElement("span", { style: { width: 11, height: 11, borderRadius: 4, outline: "1.5px solid var(--gold)", outlineOffset: -1.5 } }), "Hoy")
    )
    ));
